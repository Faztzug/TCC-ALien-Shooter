...
public class DistanceToTarget : MonoBehaviour
{
    ...
    public float effectMultplier = 1;
    private float normalizedDist = 0;
    private Material mat;
    private MeshRenderer mr;
    private void Start()
    {
        if(target == null) target = GameState.PlayerMiddleT;
    ...
    void Update()
    {
        ...
        mat.SetFloat("_WoobleAmount", normalizedDist * effectMultplier);
    }
}
